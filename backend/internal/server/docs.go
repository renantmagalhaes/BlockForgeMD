...
var CATS=[
  ...
  {id:'plugin-ai-auto-tags',label:'Plugin · AI Auto Tags',items:[
	{method:'GET',path:'/api/plugins/ai-auto-tags/config',sum:'Get personal AI auto-tag settings',
     desc:'Returns the current user\'s selected provider, model, schedule, change-recheck preference and plugin-managed tag limit.',
     curl:function(b){return b+'/api/plugins/ai-auto-tags/config'}},
	{method:'POST',path:'/api/plugins/ai-auto-tags/config',sum:'Save personal AI auto-tag settings',
     ...
     curl:function(b){return b+'/api/plugins/ai-auto-tags/config'}},
	{method:'GET',path:'/api/plugins/ai-auto-tags/models',sum:'List models from Ollama or OpenRouter',
     desc:'Lists the selected provider\'s models for the settings picker. Pass an endpoint to verify an unsaved Ollama endpoint.',
     curl:function(b){return b+'/api/plugins/ai-auto-tags/models?provider=ollama&endpoint=http%3A%2F%2Follama.example%3A11434'}},
    {method:'POST',path:'/api/plugins/ai-auto-tags/tag-file',sum:'Generate tags for one Markdown file',
     ...
     curl:function(b){return b+'/api/plugins/ai-auto-tags/tag-file'},
     resp:'{"status":"ok"}'},
  ]},
