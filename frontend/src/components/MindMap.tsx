...
const LIGHT_THEME = {
  ...
  type: 'light' as const,
  palette: ['#6366f1', '#3b82f6', '#10b981', '#f59e0b', '#ef4444', '#ec4899', '#8b5cf6'],
  cssVar: {
    ...SHARED_VARS,
    '--main-color': '#ffffff',
    '--main-bgcolor': '#6366f1',
    '--main-bgcolor-transparent': 'rgba(99,102,241,0.1)',
    '--color': '#334155',
    '--bgcolor': '#f1f5f9',
    '--selected': '#6366f1',
    '--accent-color': '#6366f1',
        ...
        const contextMenuExtend = [
          {
            ...
            onclick: async () => {
              ...
              const url = await promptDialog('Enter a URL for this node (leave empty to remove):', current, { title: 'Set hyperlink', placeholder: 'https://…', confirmLabel: 'Set', allowEmpty: true })
              if (url === null) return
